...
# load if you want to gague performance
# zmodload zsh/zprof
...
# some bussin commands

# loads .env variables into the actual environment
loadenv() {
  export $(echo $(cat .env | sed 's/#.*//g'| xargs) | envsubst)
}

# from numerous sources, will make a folder and cd you into it at the same time
function mkcd {
  last=$(eval "echo \$$#")
  if [ ! -n "$last" ]; then
...
# copy the contents of a file to clipboard, from https://github.com/StuntsPT/oh-my-zsh/blob/master/plugins/copyfile/copyfile.plugin.zsh
function copyfile {
  emulate -L zsh
  clipcopy $1
}
